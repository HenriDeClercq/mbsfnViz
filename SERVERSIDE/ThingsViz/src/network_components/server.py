...
class Server:
    def __init__(self, addressOfBroker, portOfBroker, deviceToken, topicGroup, addressOfServer, portOfServer, sleeptime):
        # MQTT BROKER VALUES
...
if __name__ == "__main__":
    ...
    main(addressOfBroker = args.addressOfBroker, portOfBroker = args.portOfBroker, deviceToken = args.deviceToken, topicGroup = args.topicGroup, addressOfServer = args.addressOfServer, portOfServer = args.portOfServer, sleeptime = args.sleeptime)
